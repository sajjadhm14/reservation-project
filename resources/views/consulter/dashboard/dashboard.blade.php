...
<head>
    ...
    <title>Consulter Dashboard</title>
...
<div class="main-wrapper">
    ...
    @include('consulter.dashboard.partials.sidebar')
    ...
    <div class="page-wrapper">
        ...
        @include('consulter.dashboard.partials.navbar')
        <!-- partial -->
        ...
        @include('consulter.dashboard.partials.footer')
        <!-- partial -->
    </div>
